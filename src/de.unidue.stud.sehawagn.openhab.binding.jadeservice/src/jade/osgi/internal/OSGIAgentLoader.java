...
public class OSGIAgentLoader implements ObjectManager.Loader {
        ...
        if (bundleName != null) {
            ...
            if (sr != null) {
                ...
                if (logger.isLoggable(Logger.FINE)) {
                    logger.log(Logger.FINE, "JADE AFS(" + bundleName + ") created agent of class " + className);
                }
    ...
    private ServiceReference<?> getAgentFactoryService(String bundleName, String bundleVersion)
            throws ClassNotFoundException {
        ServiceReference<?> af = null;
        String filter = "(" + AgentFactoryService.JADE_AFS_BUNDLE_NAME + "=" + bundleName + ")";
        if (bundleVersion != null) {
            filter = "(&" + filter + "(" + AgentFactoryService.JADE_AFS_BUNDLE_VERSION + "=" + bundleVersion + "))";
        }
        try {
            ...
            logger.log(Logger.SEVERE, "Error retrieving JADE AFS for bundle " + bundleName, e);
        }
        return af;
    }
}
