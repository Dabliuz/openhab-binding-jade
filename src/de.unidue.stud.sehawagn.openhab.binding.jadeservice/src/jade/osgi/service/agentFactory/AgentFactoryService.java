...
public class AgentFactoryService {
    ...
    public static final String JADE_AFS_BUNDLE_NAME = "jade-afs-bundle-name";
    public static final String JADE_AFS_BUNDLE_VERSION = "jade-afs-bundle-version";
     ...
     * This method is used by the framework. User should not use it.
     */
    public final Agent createAgent(String className)
