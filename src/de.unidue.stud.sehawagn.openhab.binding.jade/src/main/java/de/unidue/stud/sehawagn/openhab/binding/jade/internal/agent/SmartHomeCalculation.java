...
public class SmartHomeCalculation extends AbstractOptionModelCalculation {
	...
	@Override
	public AbstractInterfaceFlow getEnergyOrGoodFlow(TechnicalSystemStateEvaluation techSysStaEva, TechnicalInterface techInt, boolean isManualConfiguration) {
		...
		if (techInt.getDomainModel() instanceof DefaultDomainModelElectricity) {
			...
			// double reactivePower = Math.sqrt(Math.pow(apparentPower, 2) - Math.pow(activePower, 2)); // Blindleistung Q
