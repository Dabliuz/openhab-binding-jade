...
public class JADEBindingConstants {
	...
	public static final String CONFKEY_LOCAL_MAIN_PORT = "localMainPort";
	public static final String CONFKEY_LOCAL_MTP_ADDRESS = "localMTPAddress";
	public static final String CONFKEY_LOCAL_MTP_PORT = "localMTPPort";
	...
	public static final String JADE_MTP_STRING_HTTP = JADE_MTP_CLASSNAME_HTTP + "(" + JADE_MTP_PREFIX_HTTP + "%s" + ":" + "%s" + JADE_MTP_SUFFIX + ")";

	public static final String JADE_MAIN_PORT = "1099";
	public static final String JADE_DEFAULT_PLATFORMID_STRING = "%s" + ":" + "%s" + "/JADE";
	public static final String JADE_PLATFORMID_PREFIX = "openHAB";
